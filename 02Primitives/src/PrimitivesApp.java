...
public class PrimitivesApp {
	...
	public static void main(String[] args) {
		...
		System.out.println("d1 rounded to 2 decimal places = "+((double)Math.round(d1*100)/100));
		System.out.println("d1 rounded to 3 decimal places = "+((double)Math.round(d1*1000)/1000));
